...
public func tfy_setRetainedAssociatedObject<T>(_ object: Any, _ key: UnsafeRawPointer, _ value: T, _ policy: objc_AssociationPolicy = .OBJC_ASSOCIATION_RETAIN_NONATOMIC) {
    ...
    public static func getAllPropertyName(_ aClass: AnyClass) -> [String] {
        ...
        for i in 0 ..< intCount {
            ...
            guard let propertyName = NSString(utf8String: property_getName(property)) as String? else {
                TFYLog("Couldn't unwrap property name for \(property)")
                break
            }
