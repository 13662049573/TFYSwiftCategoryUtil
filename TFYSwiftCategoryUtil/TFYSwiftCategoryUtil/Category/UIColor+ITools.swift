...
public extension UIColor {
    ...
    convenience init?(hexString: String, alpha: CGFloat = 1.0) {
        let color = UIColor.tfy.hexStringToColorRGB(hexString: hexString)
    ...
    convenience init(hexInt: Int, alpha: CGFloat = 1.0) {
        let color = UIColor.tfy.hexIntToColorRGB(hexInt: hexInt)
...
public extension TFY where Base == UIColor {
    ...
    func colorToRGBA() -> (r: CGFloat?, g: CGFloat?, b: CGFloat?, a: CGFloat?) {
        ...
        return ("\(Int(red * multiplier))".tfy.toCGFloat(), "\(Int(green * multiplier))".tfy.toCGFloat(), "\(Int(blue * multiplier))".tfy.toCGFloat(), alpha)
    }
}
...
extension UIColor {
    ...
    static func GlobalColor() -> UIColor {
        return UIColor.tfy.color(r: 240, g: 240, b: 240, alpha: 1)
    }
    
    // MARK: 红色
    static func GlobalRedColor() -> UIColor {
        return UIColor.tfy.color(r: 245, g: 80, b: 83, alpha: 1.0)
    }
    
    // MARK: 字体的灰色
    static func TextGayColor() -> UIColor {
        return UIColor.tfy.color(r: 140, g: 140, b: 140, alpha: 1.0)
    }
    
    // MARK: 字体的蓝色
    static func TextzhuBlueColor() -> UIColor {
        return UIColor.tfy.color(r: 0, g: 150, b: 255, alpha: 1.0)
    }
